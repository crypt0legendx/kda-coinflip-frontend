  ...
  return (
    <nav className="w-full flex flex-row justify-between items-center p-2 text-xl my-5">
      <div className="flex items-center justify-center gap-2 w-42">
        ...
        <button><a href="https://twitter.com/kdacoinflip"><img src="./images/twitter.png" className="w-12 rounded-full" /></a></button>
        <button><a href="https://discord.gg/uDh7xqXvZ2"><img src="./images/discord.png" className="w-12 rounded-full" /></a></button>
      </div>
