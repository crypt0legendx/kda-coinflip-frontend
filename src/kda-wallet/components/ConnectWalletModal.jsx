...
function ConnectWalletModal(props) {
  ...
  const modalStyle = props.modalStyle ? props.modalStyle : "border-white border-4 rounded-md py-4 px-8 shadow-lg min-w-max max-w-xl flex flex-col space-y-4 bg-pink-400";
